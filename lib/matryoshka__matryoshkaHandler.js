MatryoshkaHandler = function () {
  ...
  that.users.deleteUser = function ( userId, username, cb ) {
    ...
    if (cb && typeof cb !== 'object')
      throw new Error('Matryoshka.users.deleteUser( userId, username, cb ): "cb" must be a object, not: ' + typeof cb);
  ...
  that.users.createUser = function ( newUser, autoLogin, cb ) {
    ...
    if (cb && typeof cb !== 'object')
      throw new Error('Matryoshka.users.createUser( newUser, autoLogin, cb ): "cb" must be a object, is: ' + typeof cb);
