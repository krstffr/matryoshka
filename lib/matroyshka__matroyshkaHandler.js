MatroyshkaHandler = function () {
    ...
    that.nestablePart.new = function( nestablePartName ) {
        
        // Create a new nestable, get it from the object in the nestables array
        var newNestable = Matroyshka.nestables[nestablePartName][0];
        
        // Set an id for the new nestable
        newNestable.matroyshkaId = that.nestablePart.generateId();

        // Set a create date
        newNestable.creationDate = new Date();
