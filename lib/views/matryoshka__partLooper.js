...
// TODO: FIX, this is due to some weird SUPER ANNOYING bug.
// https://github.com/krstffr/matryoshka/issues/44
var checkIfEventWasJustTriggered = false;
...
Template.matryoshka__partLooper.events({
		'click .matryoshka__nestable__container__col--left': function ( e ) {
			...
			// TODO: FIX, this is due to some weird SUPER ANNOYING bug.
			// https://github.com/krstffr/matryoshka/issues/44
			if (checkIfEventWasJustTriggered)
				return ;

			// TODO: FIX, this is due to some weird SUPER ANNOYING bug.
			// https://github.com/krstffr/matryoshka/issues/44
			checkIfEventWasJustTriggered = true;
