...
Template.matroyshka__partLooper.events({
    'change .matroyshka-save-on-select': function (e) {
        ...
        var updatedSession = Matroyshka.addValueInObjectBasedOnId( Session.get('aSession'), id, 'put', key, value );
    ...
    'click .delete-part': function (e) {
        ...
        var updatedSession = Matroyshka.addValueInObjectBasedOnId( Session.get('aSession'), this.id, 'delete' );
    ...
    'click .move-part': function (e) {
        ...
        var updatedSession = Matroyshka.addValueInObjectBasedOnId( Session.get('aSession'), this.id, 'move', moveWhere );
