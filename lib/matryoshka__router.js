...
MatryoshkaController = RouteController.extend({
	...
	onAfterAction: function () {
		...
		if ( Session.get('matryoshkaCurrentNestable') && Session.get('matryoshkaCurrentNestable').matryoshkaName )
			title += ' - ' + Session.get('matryoshkaCurrentNestable').matryoshkaName;
