Router.onBeforeAction(function () {
	...
	// FOR SOME REASON Route.go() does not work here, the this.data() does not display properly for the
	// setup route! TODO FIX!
	if (Matryoshka.users.loginRequired === undefined && Router.current().route.name !== 'matryoshka__setupRoute')
		window.location = '/matryoshka/setup';
...
}, { only: ['matryoshka__home', 'matryoshka', 'matryoshka__users', 'matryoshka__setupRoute'] });
